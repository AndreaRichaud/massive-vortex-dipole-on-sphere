function Compute_ground_state_on_sphere_given_theta(N_b, theta_1, output_folder)

%COMPUTE_GROUND_STATE_ON_SPHERE_GIVEN_THETA Compute a stationary state at a prescribed initial latitude.
%
%   COMPUTE_GROUND_STATE_ON_SPHERE_GIVEN_THETA(N_b, theta_1,
%   output_folder) obtains an imaginary-time stationary state of two
%   coupled Gross-Pitaevskii equations on a spherical shell. The first
%   vortex is initialized at polar angle theta_1; the second vortex is
%   placed according to the dipole geometry defined below in this file.
%
%   Inputs
%   ------
%   N_b
...
%   theta_1
%       Initial polar angle of the northern vortex [rad].
%   output_folder
